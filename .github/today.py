...
USER_NAME = os.environ['USER_NAME'] # 'efekrbs'
...
if __name__ == '__main__':
    """
    Berat Efe Karabas (efekrbs), 2026
    Based on Andrew Grant's (Andrew6rant) profile README, 2022-2025
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 6, 24))
